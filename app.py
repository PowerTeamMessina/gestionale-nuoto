...
with tab5:
    ...
    st.subheader("La classifica è il risultato della media aritmetica tra i voti di prestazione (attività in acqua, a secco e gare) e la percentuale di presenze")
